...
class ApiService {
    ...
    getRequest(url, q) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]({ fromObject: { apikey: src_app_constants__WEBPACK_IMPORTED_MODULE_2__["API_KEY"], q, metric: 'true' } });
        return this.http.get(url, { params });
    }
    getGeoPosition(lat, lng) {
...
class WeatherService extends _codewithdan_observable_store__WEBPACK_IMPORTED_MODULE_1__["ObservableStore"] {
    ...
    add(favCity) {
        ...
        this.appService.getCurrentConditions(favCity.key)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((data) => data[0]))
            .subscribe((data) => {
            state[favCity.key] = {
            ...
            console.log(state);
            this.setState(state, 'add_favCity');
        });
    }
    remove(favCity) {
        const state = this.getState() || {};
...
WeatherService.ɵfac = function WeatherService_Factory(t) { return new (t || WeatherService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](src_Services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WeatherService, [{
    ...
    }], function () { return [{ type: src_Services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }]; }, null); })();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccuweatherIconPipe", function() { return AccuweatherIconPipe; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


const IMG_URL = `https://developer.accuweather.com/sites/default/files`;
class AccuweatherIconPipe {
    transform(value) {
        if (value < 10) {
            value = `0${value}`;
        }
...
AccuweatherIconPipe.ɵfac = function AccuweatherIconPipe_Factory(t) { return new (t || AccuweatherIconPipe)(); };
AccuweatherIconPipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({ name: "accuweatherIcon", type: AccuweatherIconPipe, pure: true });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AccuweatherIconPipe, [{
...
/* harmony import */ var _fav_fav_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fav/fav.component */ "./src/app/fav/fav.component.ts");
...
const routes = [
    ...
    { path: 'fav', component: _fav_fav_component__WEBPACK_IMPORTED_MODULE_2__["FavComponent"] }
];
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 11, vars: 3, consts: [[1, "header"], [1, "title"], ["routerLink", "/", "routerLinkActive", "active", 3, "routerLinkActiveOptions"], ["routerLink", "/fav", "routerLinkActive", "active"], [1, "mode-switcher", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_div_click_8_listener() { return ctx.switchMode(ctx.mode); });
...
/* harmony import */ var _fav_fav_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./fav/fav.component */ "./src/app/fav/fav.component.ts");
...
/* harmony import */ var _accuweather_icon_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./accuweather-icon.pipe */ "./src/app/accuweather-icon.pipe.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"],
        _fav_fav_component__WEBPACK_IMPORTED_MODULE_6__["FavComponent"],
        _weather_weather_component__WEBPACK_IMPORTED_MODULE_7__["WeatherComponent"],
        _accuweather_icon_pipe__WEBPACK_IMPORTED_MODULE_8__["AccuweatherIconPipe"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _fav_fav_component__WEBPACK_IMPORTED_MODULE_6__["FavComponent"],
                    _weather_weather_component__WEBPACK_IMPORTED_MODULE_7__["WeatherComponent"],
                    _accuweather_icon_pipe__WEBPACK_IMPORTED_MODULE_8__["AccuweatherIconPipe"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "REMOVE_FAV", function() { return REMOVE_FAV; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_LNG", function() { return DEFAULT_LNG; });
const ADD_FAV = 'Add To';
const REMOVE_FAV = 'Remove From';
const API_KEY = 'KRgJjaHbsDBpSrik1gpBtWr5O8vtBGLs';
const DEFAULT_LAT = 32.109333;
const DEFAULT_LNG = 34.855499;
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var _Services_weather_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../Services/weather.service */ "./src/Services/weather.service.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _accuweather_icon_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../accuweather-icon.pipe */ "./src/app/accuweather-icon.pipe.ts");
...
function FavComponent_div_1_Template(rf, ctx) { if (rf & 1) {
...
class FavComponent {
    ...
    ngOnInit() {
        this.weatherService.stateChanged
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.ngUnSubscribe), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(state => state !== null))
            .subscribe(state => {
...
FavComponent.ɵfac = function FavComponent_Factory(t) { return new (t || FavComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_Services_weather_service__WEBPACK_IMPORTED_MODULE_3__["WeatherService"])); };
FavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FavComponent, selectors: [["app-fav"]], decls: 2, vars: 1, consts: [[1, "forecasts"], ["class", "forecast", 4, "ngFor", "ngForOf"], [1, "forecast"], [1, "title"], [1, "phrase"], [1, "temperature"], [3, "src"]], template: function FavComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/* harmony import */ var _Services_weather_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../Services/weather.service */ "./src/Services/weather.service.ts");
...
function WeatherComponent_div_2_div_1_Template(rf, ctx) { if (rf & 1) {
    const _r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function WeatherComponent_div_2_div_1_Template_div_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const suggestion_r6 = ctx.$implicit; const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r7.selectSuggestion(suggestion_r6); });
...
function WeatherComponent_div_8_Template(rf, ctx) { if (rf & 1) {
    const _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function WeatherComponent_div_8_Template_div_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.toggleFavorites(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function WeatherComponent_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    const forecast_r11 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
class WeatherComponent {
    constructor(appService, weatherService) {
        this.appService = appService;
        this.weatherService = weatherService;
    ...
    ngOnInit() {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition((position) => {
                ...
                this.appService.getGeoPosition(latitude, longitude).subscribe((data) => {
                    this.handleInitPosition(data);
                });
            });
        }
        else {
            this.appService.getGeoPosition(_constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_LAT"], _constants__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_LNG"]).subscribe((data) => {
                this.handleInitPosition(data);
            });
        }
        this.autoCompleteInput
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((data) => data.length > 0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngUnSubscribe), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((data) => {
    ...
    handleInitPosition(geoPositionRes) {
    ...
    getFiveDays(key) {
        ...
        this.appService.get5DaysOfForecasts(key).subscribe((fiveDaysForecastData) => {
...
WeatherComponent.ɵfac = function WeatherComponent_Factory(t) { return new (t || WeatherComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_Services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_Services_weather_service__WEBPACK_IMPORTED_MODULE_5__["WeatherService"])); };
WeatherComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: WeatherComponent, selectors: [["app-weather"]], decls: 11, vars: 6, consts: [["type", "text", 1, "autoComplete", 3, "ngModel", "input"], ["class", "autocomplete-suggestions", 4, "ngIf"], [1, "title"], [1, "name"], [1, "headLine"], ["class", "fav", 3, "click", 4, "ngIf"], [1, "forecasts"], ["class", "forecast", 4, "ngFor", "ngForOf"], [1, "autocomplete-suggestions"], ["class", "suggestion", 3, "click", 4, "ngFor", "ngForOf"], [1, "suggestion", 3, "click"], [1, "fav", 3, "click"], [1, "forecast"], [1, "date"], [1, "phrase"], [1, "temperature"], [3, "src"]], template: function WeatherComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "input", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function WeatherComponent_Template_input_input_1_listener($event) { return ctx.autoCompleteInput.next($event.target.value); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WeatherComponent, [{
    ...
    }], function () { return [{ type: src_Services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] }, { type: _Services_weather_service__WEBPACK_IMPORTED_MODULE_5__["WeatherService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! F:\WeatherHerolo\src\main.ts */"./src/main.ts");
